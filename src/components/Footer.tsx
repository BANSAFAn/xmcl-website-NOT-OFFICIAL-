...
export function Footer() {
  ...
  const translations = {
    en: {
      description:
        "An open-source Minecraft launcher focused on modern UX and efficient mod management.",
      disclaimer:
      ...
      copyright:
        "© 2022-2025 X Minecraft Launcher. Website by moderator Baneronetwo. Launcher created by",
    },
    ru: {
      description:
        "Minecraft лаунчер с открытым исходным кодом, ориентированный на современный интерфейс и эффективное управление модами.",
      disclaimer:
        "Это неофициальный сайт, созданный модератором XMCL Baneronetwo.",
      ...
      copyright:
        "© 2022-2025 X Minecraft Launcher. Сайт создан модератором Baneronetwo. Лаунчер создан",
    },
    uk: {
      description:
        "Minecraft лаунчер з відкритим вихідним кодом, орієнтований на сучасний інтерфейс та ефективне керування модами.",
      disclaimer:
        "Це неофіційний сайт, створений модератором XMCL Baneronetwo.",
      ...
      copyright:
        "© 2022-2025 X Minecraft Launcher. Сайт створено модератором Baneronetwo. Лаунчер створено",
    },
  };
  const text =
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <motion.div className="space-y-4" variants={itemVariants}>
            ...
            <p className="text-white/60 text-sm">{text.description}</p>
            <motion.div
            ...
            <ul className="space-y-2">
              ...
              <motion.li>
                <motion.a
                  ...
                  className="text-white/60 hover:text-white transition-colors flex items-center"
                >
                  <motion.span className="mr-1">›</motion.span>{" "}
                  {text.changelogs}
                </motion.a>
              </motion.li>
              <motion.li>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2">
              ...
              <motion.li>
                <motion.a
                  href="https://github.com/BANSAFAn/xmcl-website-NOT-OFFICIAL-"
                  variants={linkVariants}
                  initial="initial"
                  whileHover="hover"
                  className="text-white/60 hover:text-white transition-colors flex items-center"
