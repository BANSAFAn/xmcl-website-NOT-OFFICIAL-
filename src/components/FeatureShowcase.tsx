...
// Добавляем lazy loading для иконок, если нужно, но поскольку SVG inline, ок.

// Улучшаем UI: добавляем hover анимацию на карточки
// В motion.div уже есть hover: hover:shadow-lg hover:-translate-y-1

// Для code efficiency: фичи уже в массиве, хорошо.

// Возможно, добавить variants для анимаций
const cardVariants = {
...
// В return, изменить motion.div на:
<motion.div
  key={index}
