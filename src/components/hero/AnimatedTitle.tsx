            ...
            <span 
              ...
              style={{
                ...
                animation: visible[index] 
                  ? `digitalGlitch 0.5s ease forwards ${index * 0.05}s, shimmer 3s infinite 1s` 
                  : 'none'
              }}
            >
              ...
              {visible[index] && (
                <span 
                  className="absolute top-0 left-0 right-0 bottom-0 overflow-hidden opacity-0 animate-digital-noise"
                  style={{
