  ...
  return (
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        ...
        <p>
          The cache related to XMCL itself is stored in the system appdata path,
          which is different on different platforms.
        </p>
        ...
        <Tabs defaultValue="windows" className="w-full mb-6">
          ...
          <TabsContent value="appx" className="p-4 bg-black/30 rounded-lg">
            <p>
              The location is managed by Windows and may vary between versions.
            </p>
          </TabsContent>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>
            <strong>User data.</strong> Stores users' accounts, skin links, etc.
            Stored in the /user.json file.
          </li>
          <li>
            <strong>Global settings.</strong> Global settings, such as language,
            proxy URL, download node, etc. Stored in the /settings.json file.
          </li>
          <li>
            <strong>Instance cache.</strong> Records the last selected instance
            path and the paths of all known instances. Stored in the
            /instances.json file.
          </li>
          <li>
      ...
      <section className="space-y-4">
        ...
        <p>
          ...
          Minecraft data. The data directory of XMCL is slightly different from
          that of Minecraft:
        </p>
...
└─ 📂instances # Contains the instances created by XMCL`}
        ...
        <p>
          Most of the content is actually the same as Minecraft, among which the
          instances folder contains all instance files.
        </p>
      </section>
    </div>
  );
