          ...
          <>
            ...
            >
              ...
              <nav className="flex flex-col flex-1 px-6">
                ...
                <div className="flex flex-col p-4 mt-auto border-t border-border bg-muted/20">
                  <div className="grid grid-cols-4 gap-2 mb-4">
                    <a href="https://discord.gg/W5XVwYY7GQ" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-2 rounded-lg bg-indigo-500/10 text-indigo-500 hover:bg-indigo-500/20 transition-colors" title="Discord">
                    ...
                    <a href="https://kook.top/wM7X1f" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-2 rounded-lg bg-green-500/10 text-green-500 hover:bg-green-500/20 transition-colors" title="Kook">
                      <ExternalLink className="w-5 h-5" />
                    </a>
                    <a href="https://afdian.com/@ci010" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-2 rounded-lg bg-purple-500/10 text-purple-500 hover:bg-purple-500/20 transition-colors" title="Afdian">
                    ...
                    <a href="https://ko-fi.com/ci010" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center p-2 rounded-lg bg-sky-500/10 text-sky-500 hover:bg-sky-500/20 transition-colors" title="Ko-fi">
