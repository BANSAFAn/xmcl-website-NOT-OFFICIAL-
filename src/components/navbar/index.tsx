    ...
    <TooltipProvider>
      <motion.header 
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled 
            ? 'bg-black/30 backdrop-blur-md py-2 shadow-md border-b border-white/5' 
            : 'bg-transparent py-3'
        }`}
      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <motion.div 
              className="bg-white/5 backdrop-blur-sm rounded-full px-1 py-1 flex items-center"
          ...
          <div className="lg:hidden flex items-center gap-2">
            <Link 
              to="/#download" 
              className="flex items-center gap-1 px-2 py-1.5 bg-accent/80 backdrop-blur-sm text-white rounded-md text-sm"
            >
              <Download size={15} />
