// src/components/download/AnimatedDownloadSection.tsx
...
export function AnimatedDownloadSection() {
  ...
  // До цього, тут було в пізді все це із-за нейро-мереж, але довелося своїми руками налаштовувати 
  const { data: releaseData, isLoading, error } = useLatestRelease();
  const versionNumber = releaseData ? releaseData.tag_name.replace('v', '') : "0.52.4";
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <motion.h2
            ...
            variants={itemVariants}
          >
            {t('downloadSection.title')} {/* Используем i18n */}
          </motion.h2>
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            {t('downloadSection.subtitle')} {/* Используем i18n */}
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="text-left">
                <div className="text-green-400 text-sm font-medium opacity-80">{t('downloadSection.version')}</div>
                <div className="text-green-300 font-bold text-lg">{versionNumber}</div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="text-left">
                <div className="text-blue-400 text-sm font-medium opacity-80">{t('downloadSection.license')}</div>
                <div className="text-blue-300 font-bold text-lg">{t('downloadSection.free')}</div>
              </div>
            </motion.div>
            ...
            {releaseData && (
              ...
              >
                ...
                <div className="text-left">
                  <div className="text-purple-400 text-sm font-medium opacity-80">{t('downloadSection.released')}</div>
          ...
          >
            ...
            >
              ...
              >
                ...
                {t('downloadSection.selectVersion')}
                <motion.div
          ...
          <AnimatePresence>
            {showVersionSelector && (
              ...
              >
                ...
                >
                  <h3 className="text-white font-bold text-2xl mb-6 text-center">{t('downloadSection.availableVersions')}</h3>
                  <div className="space-y-4">
                    ...
                    >
                      <div className="flex items-center gap-4">
                        <Badge className="bg-green-500 text-white px-4 py-2 text-sm font-bold">{t('downloadSection.latest')}</Badge>
                        <div>
                          <div className="text-white font-bold text-lg">{versionNumber}</div>
                          <div className="text-green-300 text-sm">{t('downloadSection.stable')}</div>
                        </div>
                      </div>
                      <motion.div
                    ...
                    >
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="text-white font-bold text-lg">{t('downloadSection.allReleases')}</div>
                          <div className="text-white/70 text-sm">{t('downloadSection.viewOnGitHub')}</div>
                        </div>
                      </div>
          ...
          >
            ...
            >
              {[
                {
                  icon: CheckCircle,
                  text: t('downloadSection.feature1Title'),
                ...
                {
                  icon: Zap,
                  text: t('downloadSection.feature2Title'),
                ...
                {
                  icon: Shield,
                  text: t('downloadSection.feature3Title'),
                  color: "text-blue-400",
                ...
                >
                  ...
                  <span className="text-white/70 text-sm">{t('downloadSection.featureCheck')}</span>
                </motion.div>
              ))}
            </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-white/90 text-lg font-medium">
              {t('downloadSection.allDownloads')}{" "}
              <motion.a
              ...
              >
                {t('downloadSection.githubReleases')}
              </motion.a>
            </p>
          </motion.div>
        </motion.div>
